...
/*Here for set different parallel solution*/
/*These three options are not defined in default serial version */
/*Either SSE or AVX can be defined. They cannot both be defined */
/*FINE_GRAINED means multi-threaded version*/
# undef SSE_ENABLED 
# undef AVX_ENABLED	
...
typedef struct modelinfo
    ...
    CLFlt       *lnLI_SSE;                  /* temp storage for log site invariable likes   */
	  ...
	  int 		    numAVXChars;                /* number of compact AVX character groups       */
	  CLFlt		    *lnL_AVX;                   /* temp storage for log site likes              */
	  CLFlt   		*lnLI_AVX;                  /* temp storage for log site invariable likes   */
#endif
